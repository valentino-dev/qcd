...
%\pgfplotstableread[col sep=comma, header=false]{../data/results}\loadedtable
%\pgfplotstablemodify[rows={0}]{\loadedtable}{[index]0}{C}
%\pgfplotstablemodify[rows={2}]{\loadedtable}{[index]0}{E}
